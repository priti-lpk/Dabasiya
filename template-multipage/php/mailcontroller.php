...
if($mode=='contact'){
		...
		$mail->Subject    = "Home Builder Contact Us";
  ...
  <table border="0" cellspacing="0" cellpadding="5" width="800" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; border:1px solid #cccccc; border-collapse:collapse">
    ...
    <tr>
      <td align="center"><img src="http://www.creativethemes.co.in/demo/home-builder/template-multipage/assets/imgs/logo.png" width="170"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <tr>
			<td colspan="2"><font face="Verdana" style="font-size:12px">'.ucwords($_REQUEST['name']).' has contacted Home Builder.
</font></td>
	</tr>
          <tr>
...
if($mode=='subscriber'){
		...
		$mail->SetFrom($_REQUEST['subsemail'], "Home Builder");
		...
		$mail->Subject    = "Home Builder Subscribe";
  ...
  <table border="0" cellspacing="0" cellpadding="5" width="800" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; border:1px solid #cccccc; border-collapse:collapse">
    ...
    <tr>
      ...
      <tr>
        ...
        <tr>
			<td colspan="2"><br />
			<font face="Verdana" style="font-size:12px" color="#666666"><b>From Home Builder auto-email</b><br />
			</font>
			</td>
		</tr>
			</table></td>
...
if($mode=='middlesubscriber'){
		...
		$mail->SetFrom($_REQUEST['subsmiddleemail'], "Home Builder");
...
if($mode=='requestForm'){
		...
		$mail->Subject    = "Home Builder Request A Quote";
  ...
  <table border="0" cellspacing="0" cellpadding="5" width="800" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; border:1px solid #cccccc; border-collapse:collapse">
    ...
    <tr>
      ...
      <tr>
			<td colspan="2"><font face="Verdana" style="font-size:12px">'.ucwords($_REQUEST['name']).' has requested a quote in Home Builder.
</font></td>
	</tr>
          <tr>
...
if($mode=='faqForm'){
  ...
  <table border="0" cellspacing="0" cellpadding="5" width="800" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; border:1px solid #cccccc; border-collapse:collapse">
    ...
    <tr>
      ...
      <tr>
			<td colspan="2"><font face="Verdana" style="font-size:12px">'.ucwords($_REQUEST['name']).' has registered Home Builder.
</font></td>
	</tr>
          <tr>
...
if($mode=='blog'){
		...
		$mail->Subject    = "Home Builder Reply";
  ...
  <table border="0" cellspacing="0" cellpadding="5" width="800" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; border:1px solid #cccccc; border-collapse:collapse">
    ...
    <tr>
      ...
      <tr>
			<td colspan="2"><font face="Verdana" style="font-size:12px">'.ucwords($_REQUEST['name']).' has replied to a comment on Home Builder.
</font></td>
	</tr>
          <tr>
            <td valign="middle"><p style="font-size:13px; margin-bottom:10px; margin-top:0;  padding-left:5px;"><font style="font-family:Arial, Helvetica, sans-serif; font-size:13px"><b>Details are as follows:</b></font></p>
...
if($mode=='blog_comment'){
		...
		$mail->Subject    = "Home Builder Comment";
  ...
  <table border="0" cellspacing="0" cellpadding="5" width="800" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; border:1px solid #cccccc; border-collapse:collapse">
    ...
    <tr>
      ...
      <tr>
			<td colspan="2"><font face="Verdana" style="font-size:12px">'.ucwords($_REQUEST['comment_name']).' has commented on Home Builder.
</font></td>
	</tr>
          <tr>
            <td valign="middle"><p style="font-size:13px; margin-bottom:10px; margin-top:0;  padding-left:5px;"><font style="font-family:Arial, Helvetica, sans-serif; font-size:13px"><b>Details are as follows:</b></font></p>
